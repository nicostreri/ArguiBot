...
<template>
  <t-submenu title="Editor" class="over-bar">
    ...
    <Divider/>
    <t-menu-item :onClick="()=>{e(E.TCODE_EVENT)}">Ver/Ocultar código generado </t-menu-item>
    <t-menu-item :onClick="()=>{e(E.TTHEME_EVENT)}">Alternar apariencia visual</t-menu-item>
  </t-submenu>
</template>